...
public interface TreeStateManager<T> extends Serializable {
    ...
    void addBeforeChild(T parent, T newChild, T beforeChild, Object data, boolean isShow);
    ...
    void addAfterChild(T parent, T newChild, T afterChild, Object data, boolean isShow);
     ...
     * all.
     *
     * @param id node which children should be expanded or null if all nodes
     *           are to be expanded.
     */
    ...
    boolean isLastChild(T nodeID);

    boolean isLastVisibleItem(T nodeID);

    boolean isFirstVisibleItem(T nodeID);

    TreeNodeInfo<T> getPreviousVisibleItem(T nodeID);

    TreeNodeInfo<T> getNextVisibleItem(T nodeID);
}
